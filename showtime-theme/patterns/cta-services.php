<?php
/**
 * Title: CTA band — One provider
 * Slug: showtime/cta-services
 * Categories: showtime
 * Viewport width: 1400
 *
 * @package showtime
...
$showtime_img     = esc_url( get_theme_file_uri( 'assets/images/placeholder-hero.png' ) );
$showtime_contact = esc_url( home_url( '/contact/' ) );
?>
<!-- wp:group {"className":"st-services-gap","layout":{"type":"default"}} -->
<div class="wp-block-group st-services-gap"></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading st-cta-title">One provider, the whole production</h2>
<!-- /wp:heading -->
